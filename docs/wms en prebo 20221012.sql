...
-- Volcando estructura de base de datos para wms
CREATE DATABASE IF NOT EXISTS `wms` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
USE `wms`;
...
INSERT INTO `tpacking` (`pack_idempresa`, `pack_idpacking`, `pack_fecha`, `pack_idpedido`, `pack_idpicking`, `pack_fecinicio`, `pack_embalador`, `pack_status`, `pack_prioridad`, `pack_fecierre`, `pack_pista`, `pack_observacion`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 4, '2022-10-12 22:10:22', 'M68000305', 7, '2022-10-12 22:11:07', 'jcfreites', 1, 0, NULL, 0, NULL, 'jcfreites', '2022-10-12 22:10:22', 'jcfreites', '2022-10-12 22:31:15');
...
INSERT INTO `tpacking_bultos` (`pack_idempresa`, `pack_idpacking`, `pack_idbulto`, `pack_peso`, `pack_unidadpeso`, `pack_status`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 4, 1, 100, 'gr', b'1', 'jcfreites', '2022-10-12 22:11:08', 'jcfreites', '2022-10-12 22:16:23');
...
-- Volcando datos para la tabla wms.tpacking_detalle: ~20 rows (aproximadamente)
...
IF new.pack_status = 5 THEN
	IF fdif_picking_pedidos(new.pack_idpedido) > 0 THEN

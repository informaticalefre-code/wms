...
CREATE TABLE IF NOT EXISTS `tpacking` (
  ...
  `pack_idpedido` varchar(15) NOT NULL COMMENT 'Id del Pedido.',
  ...
  `pack_embalador` varchar(20) DEFAULT NULL COMMENT 'Es el username del preparador asignado. ',
  ...
  `pack_observacion` varchar(100) DEFAULT NULL,
...
-- Volcando datos para la tabla wms.tpacking: ~4 rows (aproximadamente)
INSERT INTO `tpacking` (`pack_idempresa`, `pack_idpacking`, `pack_fecha`, `pack_idpedido`, `pack_idpicking`, `pack_fecinicio`, `pack_embalador`, `pack_status`, `pack_prioridad`, `pack_fecierre`, `pack_pista`, `pack_observacion`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 4, '2022-10-12 22:10:22', 'M68000305', 7, '2022-10-12 22:11:07', 'jcfreites', 1, 0, '2022-10-13 21:34:51', 0, 'M68000305', 'jcfreites', '2022-10-12 22:10:22', 'jcfreites', '2022-10-13 21:36:54'),
	(1, 5, '2022-10-16 13:41:41', 'M24000300', 11, '2022-10-16 13:41:55', 'jcfreites', 1, 0, NULL, 0, NULL, 'jcfreites', '2022-10-16 13:41:41', 'jcfreites', '2022-10-16 13:41:55');
...
CREATE TABLE IF NOT EXISTS `tpacking_bultos` (
  ...
  `pack_peso` decimal(7,0) NOT NULL,
...
INSERT INTO `tpacking_bultos` (`pack_idempresa`, `pack_idpacking`, `pack_idbulto`, `pack_peso`, `pack_unidadpeso`, `pack_status`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	(1, 1, 1, 0, 'Kg', b'1', 'usuario1', '2022-07-13 11:26:56', 'usuario1', '2022-07-13 14:20:49'),
	(1, 2, 1, 0, 'Kg', b'1', 'jcfreites', '2022-07-13 15:48:18', 'jcfreites', '2022-07-13 16:01:17'),
	(1, 2, 2, 20, 'Kg', b'1', 'jcfreites', '2022-07-13 16:07:44', 'jcfreites', '2022-07-13 16:13:29'),
	(1, 2, 3, 19, 'Kg', b'1', 'jcfreites', '2022-07-13 16:13:44', 'jcfreites', '2022-07-13 16:14:26'),
	(1, 3, 1, 0, 'Kg', b'1', 'jcfreites', '2022-07-14 15:13:35', 'jcfreites', '2022-07-22 15:23:14'),
	(1, 3, 2, 0, 'Kg', b'1', 'jcfreites', '2022-07-26 11:36:18', 'jcfreites', '2022-07-26 11:38:24'),
	(1, 3, 3, 0, 'Kg', b'1', 'jcfreites', '2022-07-26 11:38:28', 'jcfreites', '2022-07-26 11:38:43'),
	(1, 3, 4, 0, 'Kg', b'1', 'jcfreites', '2022-07-26 11:38:51', 'jcfreites', '2022-07-26 11:39:05'),
	(1, 4, 1, 100, 'gr', b'1', 'jcfreites', '2022-10-12 22:11:08', 'jcfreites', '2022-10-13 21:37:24'),
	(1, 5, 1, 0, '', b'0', 'jcfreites', '2022-10-16 21:34:03', NULL, NULL);
...
-- Volcando datos para la tabla wms.tpacking_detalle: ~24 rows (aproximadamente)
INSERT INTO `tpacking_detalle` (`pacd_idempresa`, `pacd_idpacking`, `pacd_idproducto`, `pacd_unidad`, `pacd_requerido`, `pacd_cantidad`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 4, '2300-0021', 'PZA', 20, 20, 'jcfreites', '2022-10-12 22:10:22', 'jcfreites', '2022-10-12 22:11:20'),
	(1, 5, '0020-0116', 'PZA', 36, NULL, 'jcfreites', '2022-10-16 13:41:41', NULL, NULL),
	(1, 5, '0020-0120', 'PZA', 24, NULL, 'jcfreites', '2022-10-16 13:41:41', NULL, NULL),
	(1, 5, '0020-0124', 'PZA', 12, NULL, 'jcfreites', '2022-10-16 13:41:41', NULL, NULL),
	(1, 5, '0020-0126', 'PZA', 24, NULL, 'jcfreites', '2022-10-16 13:41:41', NULL, NULL);
...
-- Volcando datos para la tabla wms.tpacking_productos: ~19 rows (aproximadamente)
INSERT INTO `tpacking_productos` (`pacp_idempresa`, `pacp_idpacking`, `pacp_idbulto`, `pacp_idproducto`, `pacp_cantidad`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 4, 1, '2300-0021', 20, 'jcfreites', '2022-10-12 22:11:20', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `tpicking` (
  ...
  `pick_prioridad` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Prioridad. 0=Normal, 1=Urgente',
...
INSERT INTO `tpicking` (`pick_idempresa`, `pick_idpicking`, `pick_fecha`, `pick_idpedido`, `pick_preparador`, `pick_status`, `pick_prioridad`, `pick_fecierre`, `pick_pista`, `pick_observacion`, `pick_userverif`, `pick_fecverif`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	(1, 1, '2022-07-13 11:24:39', 'M51003161', 'usuario1', 5, 0, '2022-07-13 11:26:15', 7, '', 'usuario1', '2022-07-13 11:26:47', 'usuario1', '2022-07-13 11:24:39', 'usuario1', '2022-07-13 11:26:47'),
	(1, 2, '2022-07-13 11:24:51', 'M16002600', 'jcfreites', 1, 0, '2022-08-14 21:13:25', 6, 'prueba de observación', NULL, NULL, 'usuario1', '2022-07-13 11:24:51', 'jcfreites', '2022-08-14 21:13:55'),
	(1, 3, '2022-07-13 11:25:40', 'M17001887', 'jcfreites', 1, 0, NULL, 0, NULL, NULL, NULL, 'usuario1', '2022-07-13 11:25:40', 'jcfreites', '2022-08-16 15:27:54'),
	(1, 4, '2022-07-13 11:28:35', 'M64000636', 'usuario1', 1, 0, NULL, 0, NULL, NULL, NULL, 'usuario1', '2022-07-13 11:28:35', NULL, NULL),
	(1, 5, '2022-07-13 11:30:54', 'M52000649', 'jcfreites', 3, 1, '2022-08-17 21:59:39', 1, '', NULL, NULL, 'usuario1', '2022-07-13 11:30:54', 'jcfreites', '2022-08-17 21:59:39'),
	(1, 6, '2022-07-13 15:13:02', 'M20101113', 'usuario1', 1, 0, NULL, 0, NULL, NULL, NULL, 'jcfreites', '2022-07-13 15:13:02', NULL, NULL),
	(1, 7, '2022-07-13 15:13:20', 'M68000305', 'jcfreites', 5, 0, '2022-10-12 22:09:23', 5, '', 'jcfreites', '2022-10-12 22:10:22', 'jcfreites', '2022-07-13 15:13:20', 'jcfreites', '2022-10-12 22:10:22'),
	(1, 8, '2022-07-13 15:13:56', 'M17001885', 'jcfreites', 5, 0, '2022-07-13 15:29:49', 1, '', 'jcfreites', '2022-07-13 15:47:17', 'jcfreites', '2022-07-13 15:13:56', 'jcfreites', '2022-07-13 15:47:17'),
	(1, 9, '2022-07-13 15:16:17', 'M57001682', 'jcfreites', 1, 1, '2022-08-10 19:26:44', 0, NULL, '(NULL)', '2022-08-10 19:27:17', 'jcfreites', '2022-07-13 15:16:17', 'jcfreites', '2022-08-10 19:27:25'),
	(1, 10, '2022-07-14 15:10:17', 'M11500181', 'jcfreites', 5, 0, '2022-10-10 21:10:00', 3, '', 'jcfreites', '2022-10-10 21:13:29', 'jcfreites', '2022-07-14 15:10:17', 'jcfreites', '2022-10-10 21:13:29'),
	(1, 11, '2022-10-16 13:14:23', 'M24000300', 'jcfreites', 5, 0, '2022-10-16 13:21:23', 3, 'comentario prueba', 'jcfreites', '2022-10-16 13:41:41', 'jcfreites', '2022-10-16 13:14:23', 'jcfreites', '2022-10-16 13:41:41');
...
-- Volcando datos para la tabla wms.tpicking_bins: ~8 rows (aproximadamente)
INSERT INTO `tpicking_bins` (`picc_idempresa`, `picc_idpicking`, `picc_bin`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 2, 'PALET-6', 'jcfreites', '2022-08-14 21:13:27', NULL, NULL),
	(1, 2, 'PALET-8', 'jcfreites', '2022-08-15 19:19:55', NULL, NULL),
	(1, 5, 'PALET-1', 'jcfreites', '2022-07-13 15:43:42', NULL, NULL),
	(1, 5, 'PALET-2', 'jcfreites', '2022-08-15 16:23:35', NULL, NULL),
	(1, 7, 'PALET-5', 'jcfreites', '2022-10-12 22:09:28', NULL, NULL),
	(1, 8, 'PALET-1', 'jcfreites', '2022-07-13 15:29:49', NULL, NULL),
	(1, 10, 'PALET-3', 'jcfreites', '2022-10-10 20:47:03', NULL, NULL),
	(1, 11, 'PALET-3', 'jcfreites', '2022-10-16 13:21:30', NULL, NULL);
...
-- Volcando datos para la tabla wms.tpicking_detalle: ~42 rows (aproximadamente)
INSERT INTO `tpicking_detalle` (`picd_idempresa`, `picd_idpicking`, `picd_idproducto`, `picd_unidad`, `picd_idalmacen`, `picd_ubicacion`, `picd_requerido`, `picd_cantidad`, `picd_cantverif`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	(1, 2, '1400-0021', 'PZA', '1', '5-12-B', 2, 0, NULL, 'usuario1', '2022-07-13 11:24:51', 'jcfreites', '2022-08-16 23:44:42'),
	(1, 2, '5019-0035', 'CJA', '1', '1-3-B', 1, 1, NULL, 'usuario1', '2022-07-13 11:24:51', 'jcfreites', '2022-08-15 16:07:17'),
	(1, 2, '9110-0010', 'CJA', '1', 'MZZ-A', 1, 1, NULL, 'usuario1', '2022-07-13 11:24:51', 'jcfreites', '2022-08-16 12:14:38'),
	(1, 3, '5040-0100', 'CJA', '1', '04-08-B', 3, 0, NULL, 'usuario1', '2022-07-13 11:25:40', 'jcfreites', '2022-10-16 20:47:49'),
	(1, 3, '5040-0102', 'CJA', '1', '04-08-B', 3, 0, NULL, 'usuario1', '2022-07-13 11:25:40', 'jcfreites', '2022-10-16 20:13:41'),
	...
	(1, 7, '2300-0021', 'PZA', '1', '01-05-C', 20, 20, 20, 'jcfreites', '2022-07-13 15:13:20', 'jcfreites', '2022-10-12 22:10:02'),
	...
	(1, 9, '7121-0091', 'PZA', '1', '03-01-C', 10, 10, NULL, 'jcfreites', '2022-07-13 15:16:17', 'jcfreites', '2022-10-12 21:25:33'),
	...
	(1, 10, '2391-6084', 'GLN', '1', '6-3-A', 10, 10, 10, 'jcfreites', '2022-07-14 15:10:17', 'jcfreites', '2022-10-10 21:13:10'),
	(1, 11, '0020-0116', 'PZA', '1', '02-10-D', 36, 36, 36, 'jcfreites', '2022-10-16 13:14:23', 'jcfreites', '2022-10-16 13:39:19'),
	(1, 11, '0020-0120', 'PZA', '1', '02-10-D', 24, 24, 24, 'jcfreites', '2022-10-16 13:14:23', 'jcfreites', '2022-10-16 13:39:24'),
	(1, 11, '0020-0124', 'PZA', '1', '02-10-D', 12, 12, 12, 'jcfreites', '2022-10-16 13:14:23', 'jcfreites', '2022-10-16 13:39:29'),
	(1, 11, '0020-0126', 'PZA', '1', '02-10-D', 24, 24, 24, 'jcfreites', '2022-10-16 13:14:23', 'jcfreites', '2022-10-16 13:39:34');
...
CREATE TABLE IF NOT EXISTS `tprinter_roles` (
  `device_name` varchar(50) CHARACTER SET utf8mb3 DEFAULT NULL,
  `device_uid` varchar(100) CHARACTER SET utf8mb3 DEFAULT NULL,
  `device_descripcion` varchar(50) CHARACTER SET utf8mb3 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Contiene información de las impresoras en la cuáles se imprimen tickets y su nombre en la red a través del zebra printer browser';
...
CREATE TABLE IF NOT EXISTS `tproductos_ubica` (
  ...
  `user_mod` varchar(50) DEFAULT NULL,
  `fec_mod` datetime DEFAULT NULL,
  PRIMARY KEY (`prou_idproducto`,`prou_almacen`,`prou_ubicacion`),
  CONSTRAINT `tproductos_ubica_c01` CHECK (`prou_almacen` in ('01','02'))
...
-- Volcando datos para la tabla wms.tproductos_ubica: ~39 rows (aproximadamente)
INSERT INTO `tproductos_ubica` (`prou_idproducto`, `prou_almacen`, `prou_ubicacion`, `prou_cantidad`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	('0010-0010', '01', 'PRUEBA', 1, 'jcfreites', '2022-08-09 17:58:34', NULL, NULL),
	('0010-0011', '01', 'PRUEBA 0011', 11, 'jcfreites', '2022-08-09 17:59:13', NULL, NULL),
	('0020-0165', '01', '02-09-F', 384, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('0020-0172', '01', '02-09-F', 1440, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('0020-0220', '01', '02-01-F', 1800, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('0023-0150', '01', '02-06-F', 420, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('0040-0100', '01', '02-10-F', 240, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('0040-0102', '01', '02-10-F', 500, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('1300-0009', '01', '04-01-D', 640, 'jcfreites', '2022-08-09 13:07:55', NULL, NULL),
	('2351-0187', '01', '02-07-F', 400, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('2352-0166', '01', '02-10-F', 200, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('2352-0179', '01', '02-10-F', 1400, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('2352-0180', '01', '02-10-F', 780, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('2352-0244', '01', '05-02-D', 1584, 'sANESJ', '2022-08-09 13:07:55', NULL, NULL),
	('2394-0110', '01', '02-09-F', 1848, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('3400-0000', '01', '03-06-E', 45, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('4120-0250', '01', '02-03-F', 450, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7008-0148', '01', '03-05-E', 1080, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7008-0158', '01', '03-06-D', 330, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7008-0159', '01', '03-05-E', 70, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7060-0020', '01', '03-04-E', 750, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7060-0218', '01', '03-06-E', 600, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7121-0102', '01', '03-05-E', 60, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('7198-0107', '01', '03-04-E', 400, 'arcilal', '2022-08-09 13:07:55', 'jcfreites', '2022-08-09 13:33:43'),
	('8059-0108', '01', '02-02-F', 500, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8059-0113', '01', '02-07-F', 225, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8059-0114', '01', '02-04-F', 600, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8059-0122', '01', '02-04-F', 450, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8061-0122', '01', '02-06-F', 100, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8120-0119', '01', '02-02-F', 125, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8160-0115', '01', '02-04-F', 350, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8170-0068', '01', '02-02-F', 1400, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8170-0257', '01', '02-09-F', 1100, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8170-1017', '01', '02-04-E', 288, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8170-1018', '01', '02-04-E', 90, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8170-1023', '01', '02-04-E', 144, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8180-0004', '01', '02-04-F', 400, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8180-0009', '01', '02-04-F', 750, 'arcilal', '2022-08-09 13:07:55', NULL, NULL),
	('8180-0023', '01', '02-03-F', 250, 'arcilal', '2022-08-09 13:07:55', NULL, NULL);
...
-- Volcando datos para la tabla wms.tusuarios: ~4 rows (aproximadamente)
INSERT INTO `tusuarios` (`user_id`, `user_uuid`, `user_name`, `user_nombre`, `user_apellido`, `user_email`, `user_salt`, `user_password`, `user_token`, `user_tokenexp`, `user_activo`, `user_tipo`, `user_perfil`, `user_admin`, `user_idempresa`, `user_cedula`, `user_lastlogin`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	(1, 'e03ecbf6-9277-11ec-9738-4c72b92166c4', 'jcfreites', 'Julio', 'Cesar', 'jcfreites@hotmail.com', NULL, '$argon2i$v=19$m=4096,t=10,p=20$WjFFc3FpQzNGOGpLdFF6UQ$OGW/qmlKYr+/R7F1qVKfdCV0hfL7iJ5ysngU/OJkMZk', 'b3350786adae60b2ca55df8af2ccaa97', '2022-10-27 23:12:51', 1, '2', 'WEB', 0, 1, NULL, NULL, 'web anonimo', '2020-09-20 14:36:24', 'jcfreites', '2022-10-27 23:12:51'),
...
-- Volcando datos para la tabla wms.tusuarios_roles: ~6 rows (aproximadamente)
INSERT INTO `tusuarios_roles` (`usrr_name`, `usrr_role`, `user_crea`, `fec_crea`, `user_mod`, `fec_mod`) VALUES
	...
	('jcfreites', 'EMBALADOR', 'jcfreites', '2022-10-09', NULL, NULL),
	('jcfreites', 'PREPARADOR', 'jcfreites', '2022-08-16', NULL, NULL),
	...
	('usuario3', 'EMBALADOR', 'jcfreites', '2022-06-19', 'jcfreites', '2022-10-09');
...
CREATE TABLE `vpacking` (
	...
	`pack_idpedido` VARCHAR(15) NOT NULL COMMENT 'Id del Pedido.' COLLATE 'utf8mb4_general_ci',
	`pack_idpicking` INT(11) NOT NULL COMMENT 'Id. del Picking. En caso que venga del picking.',
	`pack_fecinicio` DATETIME NULL COMMENT 'Inicio de tarea de Packing por parte del embalador.',
	`pack_embalador` VARCHAR(20) NULL COMMENT 'Es el username del preparador asignado. ' COLLATE 'utf8mb4_general_ci',
	...
	`pack_observacion` VARCHAR(100) NULL COLLATE 'utf8mb4_general_ci',
...
CREATE TABLE `vpicking` (
	...
	`pick_prioridad` TINYINT(1) NOT NULL COMMENT 'Prioridad. 0=Normal, 1=Urgente',
...
IF new.user_mod iS NULL THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'No hay usuario de update';
END IF;
IF new.pack_status = 5 THEN
	IF fdif_packing_pedidos(new.pack_idpedido) > 0 THEN
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vpacking_bultos` AS SELECT * FROM `tpacking_bultos` ;

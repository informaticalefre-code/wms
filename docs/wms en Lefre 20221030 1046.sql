...
DROP FUNCTION IF EXISTS `fdif_packing_pedidos`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fdif_picking_pedidos`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fnext_idpacking`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fnext_idpicking`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fpack_bultos_productos`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fpack_bultos_status`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fpicking_status`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fuser_empresa`;
DELIMITER //
...
DROP FUNCTION IF EXISTS `fvalida_preparador`;
DELIMITER //
...
DROP TABLE IF EXISTS `tbackorder`;
...
DROP TABLE IF EXISTS `tmenu_roles`;
...
DROP TABLE IF EXISTS `toperadores`;
...
-- Volcando datos para la tabla wms.tpacking: ~1 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpacking_bultos`;
...
-- Volcando datos para la tabla wms.tpacking_bultos: ~3 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpacking_detalle`;
...
-- Volcando datos para la tabla wms.tpacking_detalle: ~4 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpacking_productos`;
...
-- Volcando datos para la tabla wms.tpacking_productos: ~4 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpedidos_status`;
...
-- Volcando datos para la tabla wms.tpicking: ~2 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpicking_bins`;
...
-- Volcando datos para la tabla wms.tpicking_bins: ~1 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpicking_detalle`;
...
-- Volcando datos para la tabla wms.tpicking_detalle: ~6 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tpicking_pistas`;
...
DROP TABLE IF EXISTS `tproductos_ubica`;
...
-- Volcando datos para la tabla wms.tproductos_ubica: ~52 rows (aproximadamente)
...
DROP TABLE IF EXISTS `treserva_productos`;
...
-- Volcando datos para la tabla wms.tusuarios: ~9 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tusuarios_roles`;
...
-- Volcando datos para la tabla wms.tusuarios_roles: ~9 rows (aproximadamente)
...
DROP VIEW IF EXISTS `vpacking_bultos`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpacking_detalle`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpacking_productos`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpacking_tarea`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpicking_bins`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpicking_detalle`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpicking_pistas`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vpicking_tarea`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vproductos_ubica`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vstats_preparador`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vstats_preparador2`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `v_picking_prod_anclados`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP TRIGGER IF EXISTS `tempresas_tr01`;
...
DROP TRIGGER IF EXISTS `tempresas_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_bultos_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_bultos_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_bultos_tr03`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_bultos_tr04`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_detalle_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_detalle_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_productos_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_productos_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_productos_tr03`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_tr02`;
...
DROP TRIGGER IF EXISTS `tpacking_tr03`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpacking_tr04`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpedidos_status_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpedidos_status_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_container_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_container_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_detalle_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_detalle_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_detalle_tr03`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_detalle_tr04`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_detalle_tr05`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tpicking_tr04`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tproductos_ubica_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tproductos_ubica_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tusuarios_roles_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tusuarios_roles_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tusuarios_tr01`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `tusuarios_tr02`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //

...
<body>
<?php
    require 'config/header_barra_tareas_packing.php';
?>
    <main id="main_screen">
        <div hidden id="spinner"></div>
        <div><h4 class='titulos_categorias'>Tareas de Packing</h4></div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <form method="post" id="form-filter" autocomplete="off">
                ...
                <hr>
                <div>
                    <button type="button" name="aplicar_fitro" id="aplicar_filtro" class="btn btn-primary" data-bs-dismiss="offcanvas" onclick="aplica_filtro();">Filtrar</button>
                </div>                
            </form>
        </div>
    </div>
...
<script type = "text/JavaScript">
    ...
    /*************************************************************************************
    *                              CARGA TAREAS PACKING
    **************************************************************************************/
    function carga_tareas_packing(pnbloque){
        ...
        fetch('api/ap_packingmaster.php',{method:'POST',body:formData})

<?php
    ...
    *************************************************************************/
    function carga_tarea_packing($pid_packing){
        ...
        $out["chequeador"]  = $opacking->user_crea;
    ...
    *************************************************************************/
    function update_packing_data(){
        ...
        $opacking->user_crea        = test_input($_POST["input-chequeador"]);
        ...
        unset($_POST["input-status"], $_POST["input-prioridad"], $_POST["input-chequeador"], $_POST["input-pista"], $_POST["input-observacion"]);

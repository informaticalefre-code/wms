<?php
    ...
    ***********************************************************************/
    function query_productos($sql_obj, $pbloque){
        ...
        // Armamos el SQL
        $sql  = "SELECT tabla1.codigo_pro, tabla1.nombre_pro, tabla1.unidad_pro, tabla1.existencia_pro, tabla1.deposito1_pro, tabla1.deposito2_pro, tabla1.deposito3_pro, tabla1.ubicacion_pro, tabla1.codigobarra_pro, tabla1.referencia_pro, tabla1.desmarca, RowNum FROM (";
        $sql .= "SELECT a.codigo_pro, a.nombre_pro, a.unidad_pro, a.existencia_pro, a.deposito1_pro, a.deposito2_pro, a.deposito3_pro, a.ubicacion_pro, a.codigobarra_pro, a.referencia_pro, ISNULL(b.desmarca,'*sin marca*') as desmarca,
    ...
    function html_productos_lista($aproductos){
        ...
        if (count($aproductos)> 0){
            foreach($aproductos as $fila):
                ...
                $obj->deposito1_pro   = $fila["deposito1_pro"];
                $obj->deposito2_pro   = $fila["deposito2_pro"];
                $obj->deposito3_pro   = $fila["deposito3_pro"];
    ...
    ***********************************************************************/
    function html_productos_linea($oproducto){
        ...
        $out .= '<td style="text-align:right;">'.number_format($oproducto->deposito1_pro,2).'</td>';
    ...
    ***********************************************************************/
    function carga_producto($idproducto){
        ...
        if (!$oproducto->error){
            ...
            $out["existencia"]  = $oproducto->deposito1_pro;
            $out["deposito1_pro"]  = $oproducto->deposito1_pro;
            $out["deposito2_pro"]  = $oproducto->deposito2_pro;
            $out["deposito3_pro"]  = $oproducto->deposito3_pro;

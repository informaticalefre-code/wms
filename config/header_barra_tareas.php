        ...
        <div id="barra-cont-form-search">
            <form class="barra-form-search" method="post" id="form-search" onsubmit="barra_buscar()">
                ...
                <div id="search-options" style="color:white;">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="search-options" id="inlineRadio2" value="preparador" onchange="activa_search_focus()">
                        <label class="form-check-label text-light" for="inlineRadio2">Preparador</label>
                    </div>
                    <div class="form-check form-check-inline">

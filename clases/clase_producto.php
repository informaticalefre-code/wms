...
class Producto {
    ...
    public $deposito1_pro;
    public $deposito2_pro;
    public $deposito3_pro;
    ...
    **************************************************************/
    function carga_productos_master(){
        $this->error = false;
        $sql = "select codigo_pro, nombre_pro, unidad_pro, referencia_pro, existencia_pro, deposito1_pro, deposito2_pro, deposito3_pro, inactivo_pro, ubicacion_pro, codigobarra_pro, BultoOriginal_Pro, EmpaqueOriginal_Pro
                from TbProductos
        ...
        if ($stmt->execute()):
            ...
            if ($stmt->rowcount() > 0):
                ...
                $this->deposito1_pro       = $resp["deposito1_pro"];
                $this->deposito2_pro       = $resp["deposito2_pro"];
                $this->deposito3_pro       = $resp["deposito3_pro"];

            ...
            <div id="packing-form">
                <div id="packing-master">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-2">
                            <label for="input-verificador" class="form-label mb-0">Verificador</label>
                            <select class="form-select" id="input-verificador" name="input-verificador" aria-label="Nombre del embalador">
                            </select>
                        </div>
                    </div>
                    <div class="row">
...
<script type = "text/JavaScript">
    ...
    *                             CARGA EMBALADORES
    **************************************************************************************/
    function carga_verificador(){
        let url = new URL(location.origin + '/wms/api/ap_preparadores.php');
        url.searchParams.append('accion', 'verificador');
        
        fetch(url,{method:'GET', headers: {'Content-type':'application/json; charset=UTF-8'}})
        .then((response) => response.json())
        .then((responseJson) => {
            document.getElementById("input-verificador").insertAdjacentHTML('beforeend',responseJson.html_verificador);
        });
        url = null;
    };
</script>